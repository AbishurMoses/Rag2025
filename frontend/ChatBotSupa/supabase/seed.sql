...
('e9fc7e46-a8a5-4fd4-8ba7-af485013e6fa', 'Workspace 1', 'This is for testing.', 4000, 'llma3.2:latest', 'You are an assistant.', 0.5, true, true, 'These are the instructions.', false, 'private', 'local');
